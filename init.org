...
* TODO Improvements [11/16] 
- [X] Add redo ability
- [X] Add in-line suggestions
- [X] Org-specific bindings
- [X] Mode dependent bindings (for org-mode specifically)
- [X] Ord-modern
- [X] Better org-modern styles (specifically the headers)
- [X] Javelline (or any Harpoon equivalent)
- [X] Gc from nvim
- [ ] Better copy and paste in insert
- [ ] Add better org-mode captures
- [ ] Org-roam
- [ ] Easy link paste from clipboard
- [ ] Easy image paste from clipboard
- [X] Org-appear for better styling
- [X] Projectile with consult and mappings
- [X] Better fonts for org-mode with gruvbox (and mixed-pitch)
...
** Evil GC commenting
Emulate gc binding nvim behavior
